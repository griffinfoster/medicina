#!/usr/bin/env python
'''
Grabs the contents of "snap_tge0" (one per FPGA) at the output of the X eng
...
if __name__ == '__main__':
    ...
    p = OptionParser()
    p.set_usage('xeng_snap_tge.py [options] CONFIG_FILE')
...
try:
    ...
    sys.stdout.flush()
    bram_dmp=xeng.xeng_snap(dev_name, brams, man_trig = manual, wait_period = 30)
    print 'done.'
