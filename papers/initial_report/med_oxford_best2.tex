...
Deriving the complex gain terms to be applied to the antennas can be achieved with any desired calibration method, and may or may not require knowledge of the array topology or sky model \citep(cal_strategies).
