...
%This new optimized design efficiently uses the full bit width of the Xilinx DSP48e multipliers to reduce the total multiplier usage by a 75\%.
...
%    \includegraphics[width=0.9\textwidth]{{graphics/gain_phs_var_deplane_crop}.pdf}
